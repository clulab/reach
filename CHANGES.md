#Changes
=======
+ **1.2.2** - Context engine now can be configured by the user. Added a new deterministic context policy that drags context before and after a mention. Added support for Pandas output format
