...
trait KnowledgeBaseConstants {
  ...
  val KBDirFilePath = "src/main/resources/edu/arizona/sista/odin/domains/bigmechanism/reach/kb"

  /** Resource Path to the directory which holds the entity knowledge bases. */
  val KBDirResourcePath = "/edu/arizona/sista/odin/domains/bigmechanism/reach/kb"
