...
//    "Ala mutant at Thr149 was phosphorylated by Cdk5/p35, similarly to the unmutated fragment."
  ...
  // Series should not work with 'and' (because we could have "Ras and Akt (a.k.a. Ras334 and Akt4H)"),
  // which isn't handled yet.
  val sent53 = "Akt (a.k.a. Akt334 and Akt4H) is phosphorylated."
  sent53 should "not apply Akt grounding to other proteins" in {
  ...
  // Alias assignment works in any order, and across sentences!
  val sent54a = "Akt (also called Akt334, AktTR, or Akt4H) is phosphorylated. AktTR is also ubiquitinated."
  sent54a should "apply Akt grounding to 3 proteins" in {
    val mentions = getBioMentions(sent54a)
    val akt = mentions filter (m => m.text == "Akt")
    akt should have size (1)
    val s2akt = mentions filter (m => m.sentence == 1 && m.matches("Entity"))
    s2akt should have size (1)
  ...
  val sent54b = "AktTR is ubiquitinated. Akt, previously known as Akt334, AktTR, or Akt4H, is also phosphorylated."
  sent54b should "apply Akt grounding to 3 proteins" in {
