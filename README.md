...
# Licensing
This project is, and will always be, free for *research purposes*. However, starting with version 1.2, we are using a licence that restricts its use for *commercial purposes*. Please contact us for details.
