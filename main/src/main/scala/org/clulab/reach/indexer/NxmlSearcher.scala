...
class NxmlSearcher(val indexDir:String) {
  ...
  def useCaseMicroBiology(resultDir:String): Unit = {
    vanillaUseCase(
      """ "Natronorubrum sp." OR "uncultured phenanthrene-degrading archaeon" OR "Natronoarchaeum sp. AArc1" OR "Candidatus Bathyarchaeota archaeon B24-2" OR "Thermoplasmatales archaeon JGI SC39-E20" OR "Saliphagus" OR "Halobacterium litoreum" OR "archaeon AQ6F" OR "Salinirussus" OR "Candidatus Methanoperedens sp. BLZ2" OR "Euryarchaeota archaeon JGI CrystG Aug3-3-I7" OR "Euryarchaeota archaeon JGI CrystG Aug3-3-I21" OR "Euryarchaeota archaeon JGI CrystG Aug3-3-F14" OR "Euryarchaeota archaeon JGI CrystG Aug3-3-C16" OR "Euryarchaeota archaeon JGI CrystG Aug3-1-I17" OR "Euryarchaeota archaeon JGI CrystG Aug3-1-F4" OR "Euryarchaeota archaeon JGI CrystG Aug3-1-D16" OR "Euryarchaeota archaeon JGI CrystG Aug3-1-C22" OR "Euryarchaeota archaeon JGI CrystG Apr3-4-C6" OR "Halobium" """.stripMargin, resultDir)
  }
