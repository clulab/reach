...
class TestPolarity extends FlatSpec with Matchers{
  ...
  sen8 should behave like positiveActivationBehavior(sen8, "RET", "AKT")
  ...
  sen11 should behave like negativeActivationBehavior(sen11, "MAPK", "Mitf")
  ...
  sen16 should behave like positiveActivationBehavior(sen16, "STAT3", "IL-6")
  ...
  sen1 should behave like positiveActivationBehavior(sen1, "Skp2", "p27")
  ...
  sen23 should behave like negativeActivationBehavior(sen23, "SIRT1", "p53")
  ...
  sen24 should behave like negativeActivationBehavior(sen24, "Skp2", "p21")
  ...
  sen25 should behave like negativeActivationBehavior(sen25, "ABT-737", "Bcl-2")
  ...
  sen26 should behave like negativeActivationBehavior(sen26, "ERK", "EGFR")
  ...
  sen28 should behave like negativeActivationBehavior(sen28, "Smo", "Sufu")
  ...
  sen29 should behave like positiveActivationBehavior(sen29, "insulin", "Akt")

  val sen30 = """EGF, but not TGF alpha, efficiently induces degradation of the EGF receptor (EGFR)."""
  sen30 should behave like positiveActivationBehavior(sen30, "EGF", "EGF receptor")
  ...
  sen31 should behave like negativeActivationBehavior(sen31, "SIRT1", "p53")
  ...
  sen32 should behave like negativeActivationBehavior(sen32, "Mcl1", "Bax")
  ...
  sen33 should behave like negativeActivationBehavior(sen33, "Navitoclax", "BCL-w")
  ...
  sen35 should behave like positiveActivationBehavior(sen35, "androgen receptor", "AR")
  ...
  sen36 should behave like negativeActivationBehavior(sen36, "Mcl-1", "Bax")
  ...
  sen38 should behave like positiveActivationBehavior(sen38, "PALB2", "BRCA2")
  ...
  sen41 should behave like positiveActivationBehavior(sen41, "EGF", "EGFR")
  ...
  sen43 should behave like negativeActivationBehavior(sen43, "bcl-2", "cytochrome c")

  val sen44 = """Keap1 still modulates the redox sensitivity of Nrf2 by controlling the availability of free Nrf2 proteins."""
  sen44 should behave like negativeActivationBehavior(sen44,"Keap1", "Nrf2" )
  ...
  sen45 should behave like negativeActivationBehavior(sen45,"Keap1", "Nrf2" )
  ...
  sen46 should behave like negativeActivationBehavior(sen46, "SOCS3", "STAT3")
  ...
  sen47 should behave like positiveActivationBehavior(sen47, "ER", "ERbeta")
  ...
  sen48 should behave like negativeActivationBehavior(sen48, "Pten", "Akt")
  ...
  sen49 should behave like negativeActivationBehavior(sen49, "PTEN", "Akt")

  val sen50 = """Noggin increased BMP-4 transcripts, suggesting autocrine control of BMP-4 expression."""
  sen50 should behave like negativeActivationBehavior(sen50, "Noggin", "BMP-4")
  ...
  sen51 should behave like negativeActivationBehavior(sen51, "VHL", "HIF-1alpha")
  ...
  sen52 should behave like negativeActivationBehavior(sen52,"ABT-737", "Bcl-xL")

  val sen53 = """Taken together, we conclude that SRT1720, SRT2183, SRT1460, and resveratrol are not direct activators of SIRT1."""
  sen53 should behave like negativeActivationBehavior(sen53, "SRT1720", "SIRT1")
  ...
  sen54 should behave like negativeActivationBehavior(sen54, "Temsirolimus", "mTOR")
  ...
  sen58 should behave like negativeActivationBehavior(sen58, "caspase-7", "PARP")
}
